...
export interface Alignment { offset?: number; characters: string[]; starts: number[]; ends: number[] }
export interface Speech { clock: AudioContext; start: number; duration: number; samples: Float32Array; sampleRate: number; visemes: VisemeCue[]; alignment: Alignment; mood: Mood; text: string; charOffset: number }
